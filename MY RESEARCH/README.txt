usage: passiveObserver2.py [-h] [--workers WORKERS] [--rate-limit RATE_LIMIT] [--timeout TIMEOUT] [--max-pcap-mb MAX_PCAP_MB]
...
python3 passiveObserver2.py <Path to input file (HAR, Burp XML, PCAP, or Spider Hellhound JSON)>
