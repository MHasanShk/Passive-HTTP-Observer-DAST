usage: passiveObserver5.py [-h] [--workers WORKERS] [--rate-limit RATE_LIMIT] [--timeout TIMEOUT] [--max-pcap-mb MAX_PCAP_MB]
                           [--passive-rate-limit PASSIVE_RATE_LIMIT] [--verbose] [--no-tls-detection]
                           file

Passive HTTP Observer v9.3 - Comprehensive Security Analysis Tool

positional arguments:
  file                  Path to input file (HAR, Burp XML, PCAP, or JSON)
...
python3 passiveObserver5.py <Path to input file (HAR, Burp XML, PCAP, or Spider Hellhound JSON)>
